                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-three-tab1" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="date">{{ $mode === 'create' ? '' : $anaweri->date }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('level_of_description') }}
                                            </label>
                                            <textarea class="form-control"
                                                name="level_of_description">{{ $mode === 'create' ? '' : $anaweri->level_of_description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-three-tab5" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="related_units_of_description">{{ $mode === 'create' ? '' : $anaweri->related_units_of_description }}</textarea>
                                        </div>
                                        <div class="form-group">
