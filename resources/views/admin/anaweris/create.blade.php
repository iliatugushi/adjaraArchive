...
@section('content')
<form method="post"
    action="{{ $mode === 'create' ? route('anaweris.store') : route('anaweris.update', ['anaweri' => $anaweri->id]) }}"
                        ...
                        <h3 class="card-title caps">
                            <b>
                                ...
                                <span style=" color:#9e9e9e;font-weight:100;">
                                    ...
                                    @else
                                    {{ $anaweri->reference_code }} - რედაქტირება
                                    @endif
                                </span>
                            </b>
                        </h3>
                        <div class="card-tools">
                            <a href="{{route('anaweris.index', ['fond' => $fond->id])}}"
                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    <div class="tab-pane fade show active" id="custom-tabs-three-tab1" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="reference_code"
                                                required>{{ $mode === 'create' ? '' : $anaweri->reference_code }}</textarea>
                                        </div>
                                        <div class=" form-group">
                                            <label>{{ __('title') }} *</label>
                                            <textarea class="form-control" name="title"
                                                required>{{ $mode === 'create' ? '' : $anaweri->title }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('date') }} </label>
                                            <input type="text" class="form-control datePicker" name="date"
                                                value="{{ $mode === 'create' ? '' : $anaweri->date }}"
                                                autocomplete="off" />
                                        </div>
                                        <input type="hidden" name="level_of_description" value="ანაწერი" />
                                        <div class="form-group">
                                            <label>{{ __('extent_and_medium_of_the_unit_of_description') }}
                                            </label>
                                            <textarea class="form-control"
                                                name="extent_and_medium_of_the_unit_of_description">{{ $mode === 'create' ? '' : $anaweri->extent_and_medium_of_the_unit_of_description }}</textarea>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-three-tab2" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="name_of_creator">{{ $mode === 'create' ? '' : $anaweri->name_of_creator }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('administrative_biographical_history') }} </label>
                                            <textarea class="form-control"
                                                name="administrative_biographical_history">{{ $mode === 'create' ? '' : $anaweri->administrative_biographical_history }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('archival_history') }} </label>
                                            <textarea class="form-control"
                                                name="archival_history">{{ $mode === 'create' ? '' : $anaweri->archival_history }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('immediate_source_of_acquisition_or_transfer') }} </label>
                                            <textarea class="form-control"
                                                name="immediate_source_of_acquisition_or_transfer">{{ $mode === 'create' ? '' : $anaweri->immediate_source_of_acquisition_or_transfer }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="custom-tabs-three-tab3" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="scope_and_content">{{ $mode === 'create' ? '' : $anaweri->scope_and_content }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('appraisal_destruction_and_scheduling_information') }} </label>
                                            <textarea class="form-control"
                                                name="appraisal_destruction_and_scheduling_information">{{ $mode === 'create' ? '' : $anaweri->appraisal_destruction_and_scheduling_information }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('accruals') }} </label>
                                            <textarea class="form-control"
                                                name="accruals">{{ $mode === 'create' ? '' : $anaweri->accruals }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('system_of_arrangement') }} </label>
                                            <textarea class="form-control"
                                                name="system_of_arrangement">{{ $mode === 'create' ? '' : $anaweri->system_of_arrangement }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="custom-tabs-three-tab4" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="conditions_governing_access">{{ $mode === 'create' ? '' : $anaweri->conditions_governing_access }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('conditions_governing_reproduction') }}
                                            </label>
                                            <textarea class="form-control"
                                                name="conditions_governing_reproduction">{{ $mode === 'create' ? '' : $anaweri->conditions_governing_reproduction }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('language_scripts_of_material') }} </label>
                                            <textarea class="form-control"
                                                name="language_scripts_of_material">{{ $mode === 'create' ? '' : $anaweri->language_scripts_of_material }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="physical_characteristics_and_technical_requirements">{{ $mode === 'create' ? '' : $anaweri->physical_characteristics_and_technical_requirements }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('finding_aids') }} </label>
                                            <textarea class="form-control"
                                                name="finding_aids">{{ $mode === 'create' ? '' : $anaweri->finding_aids }}</textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="custom-tabs-three-tab5" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="existence_and_location_of_originals">{{ $mode === 'create' ? '' : $anaweri->existence_and_location_of_originals }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('existence_and_location_of_copies') }} </label>
                                            <textarea class="form-control"
                                                name="existence_and_location_of_copies">{{ $mode === 'create' ? '' : $anaweri->existence_and_location_of_copies }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="related_units_of_description"
                                                ...
                                                readonly>{{ $mode === 'create' ? '' : $anaweri->related_units_of_description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('related_units_of_description_comment') }} </label>
                                            <textarea class="form-control" name="related_units_of_description_comment"
                                                id="related_units_of_description_comment">{{ $mode === 'create' ? '' : $anaweri->related_units_of_description_comment }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('publication_note') }} </label>
                                            <textarea class="form-control"
                                                name="publication_note">{{ $mode === 'create' ? '' : $anaweri->publication_note }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-three-tab6" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            <label>{{ __('note') }} </label>
                                            <textarea class="form-control"
                                                name="note">{{ $mode === 'create' ? '' : $anaweri->note }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-three-tab7" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                name="archivists_note">{{ $mode === 'create' ? '' : $anaweri->archivists_note }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('rules_or_conventions') }} </label>
                                            <textarea class="form-control"
                                                name="rules_or_conventions">{{ $mode === 'create' ? '' : $anaweri->rules_or_conventions }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ __('date_of_descriptions') }} </label>
                                            <textarea class="form-control"
                                                name="date_of_descriptions">{{ $mode === 'create' ? '' : $anaweri->date_of_descriptions }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@if($mode === 'edit')
<form id="delete-form" action="{{ route('anaweris.destroy', [$anaweri->id]) }}" method="post" style="display:none;">
